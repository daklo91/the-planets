      ...
      <div className="max-w-[1086px] m-auto">
        <div className="grid lg:grid-cols-[582px_minmax(0,1fr)_350px] mb-[87px] sm:mx-10 lg:mx-0">
          ...
          <div className="order-3 md:order-none md:max-w-[339px] md:mr-4 lg:col-start-3">
            <h1 className="text-[2.5rem] sm:text-[3rem] lg:text-[5rem] font-antonio font-medium text-primary uppercase mb-[23px]">
              {planetData.name}
            </h1>
          ...
          <PlanetViewLinks
            className="order-1 flex md:block lg:col-start-3 md:max-w-[281px] lg:max-w-none md:ml-auto lg:ml-0"
            currentPlanet={planetData.name.toLowerCase()}
            viewParam={lowerCaseView}
            UIColor={planetData.UIColor}
          />
        </div>
        <div className="flex flex-col md:flex-row gap-[30px] max m-auto">
          ...
          <PlanetDetailCard planetStat={planetData.radius}>
            RADIUS
          </PlanetDetailCard>
