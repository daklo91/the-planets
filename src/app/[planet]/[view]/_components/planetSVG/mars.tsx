...
export default function mars({ showGuts }: PlanetSVGProps) {
  return (
    <svg
    ...
    >
      ...
      <g mask="url(#mask0_921_144)">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M213 147C219.627 147 225 152.373 225 159C225 165.627 219.627 171 213 171H164C157.373 171 152 176.373 152 183C152 189.627 157.373 195 164 195H291C297.627 195 303 189.627 303 183C303 176.373 297.627 171 291 171H278L277.999 170.99C271.604 170.727 266.5 165.46 266.5 159C266.5 152.54 271.604 147.273 277.999 147.01L278 147H334C340.627 147 346 141.627 346 135C346 128.373 340.627 123 334 123H178C171.373 123 166 128.373 166 135C166 141.627 171.373 147 178 147H213ZM409 183C409 176.373 403.627 171 397 171H392C385.373 171 380 176.373 380 183C380 189.627 385.373 195 392 195H397C403.627 195 409 189.627 409 183Z"
          fill="#FF9B6B"
        />
      </g>
      <mask
      ...
      <path
        d="M292 130C380.918 130 453 202.082 453 291C453 379.918 380.918 452 292 452V130Z"
        fill="#97271E"
      />
      <mask
        id="mask4_921_144"
